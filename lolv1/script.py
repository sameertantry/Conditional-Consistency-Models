...
class ImageDataModuleConfig:
    data_dir: str = "datasets/lolv1"  # Path to the dataset directory
    ...
    num_workers: int = 6  # Number of worker threads for data loading
...
class LLVIPDataModule(LightningDataModule):
    ...
    def setup(self, stage: str = None) -> None:
        ...
        self.dataset = PairedDataset(
            visible_dir=os.path.join(self.config.data_dir, "our485/low"),
            infrared_dir=os.path.join(self.config.data_dir, "our485/high"),
...
class TrainingConfig:
    ...
    trainer: Trainer
    model_ckpt_path: str = "checkpoints/lolv1_128x128"
    seed: int = 42
